          ...
          <div class="row">
            <div class="col-md-12">
              <div class="card">
                ...
                <div class="card-body">
                  <a href="add_client.php" class="btn btn-primary" style="background:#6610f2;">Add</a>
                  <?php
                     $result = $conn->query("SELECT * FROM client") or die($conn->error);
                   ?>
                  <table class="table table-hover">
                    ...
                    <?php while ($row = $result->fetch_assoc()):?> 
                      ...
                      <tr>
                        ...
                        <td>
                        <form action="edit_client.php" method="post" style="display:inline">
...
if (isset($_POST['del_contact'])){
  ...
  $result = $conn->query("SELECT * FROM client WHERE id='$id' ") or die($conn->error);
    ...
    $sql = "DELETE FROM client WHERE id='$id' ";
            ...
            echo "<script> alert('clienter Deleted.') </script>";
}
